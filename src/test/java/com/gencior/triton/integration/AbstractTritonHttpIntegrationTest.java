...
@Testcontainers
public abstract class AbstractTritonHttpIntegrationTest {
    ...
    protected static TritonHttpClient client;
    ...
    static void initClient() {
        String httpTarget = tritonContainer.getHost() + ":" + tritonContainer.getMappedPort(8000);
        TritonClientConfig config = new TritonClientConfig.Builder(httpTarget)
                .timeout(30000)
                .build();
